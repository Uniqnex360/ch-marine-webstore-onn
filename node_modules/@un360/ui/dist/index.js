...
const ChatWidget = ({ apiKey, productContext: providedContext, apiBaseUrl, position = 'bottom-right', theme = {}, greetingMessage, placeholder = 'Type your message...', }) => {
    const [isOpen, setIsOpen] = React.useState(false);
    const [isMinimized, setIsMinimized] = React.useState(false);
    const [isMaximized, setIsMaximized] = React.useState(false);
    const [productContext, setProductContext] = React.useState(null);
    ...
    React.useEffect(() => {
        if (providedContext) {
            ...
            try {
                ...
                const extracted = core.extractProductFromPage();
    ...
    const { messages, sendMessage, isBotTyping, suggestedQuestions, } = core.useChat({
        apiKey,
    ...
    return (React.createElement("div", { ref: chatRef, role: "dialog", "aria-label": "Product chat widget", "aria-modal": "true", style: {
            position: 'fixed',
            [position.includes('right') ? 'right' : 'left']: '20px',
            [position.includes('bottom') ? 'bottom' : 'top']: '20px',
        ...
        !isMinimized && (React.createElement(React.Fragment, null,
            React.createElement(ChatMessages, { messages: messages, isBotTyping: isBotTyping, greetingMessage: defaultGreeting, suggestedQuestions: suggestedQuestions, onQuestionClick: (question) => sendMessage(question), theme: defaultTheme }),
...
exports.SuggestedQuestions = SuggestedQuestions;
